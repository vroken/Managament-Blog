...
@section('container')
    ...
    <div class="card-body">
        <form method="post" action="/dashboard/categories/{{ $update->slug }}" enctype="multipart/form-data">
            @method('put')
            @csrf 
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name')is-invalid @enderror" id="name" name="name" value="{{ old('name', $update->name) }}">
                        @error('name')
            ...
            <button type="submit" class="btn btn-primary pull-right mt-5">Update Category</button>
