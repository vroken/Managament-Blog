    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 mx-auto">
          <h1 class="mb-4">About Blog</h1>
          <ul class="list-inline">
            <li class="list-inline-item"><a class="text-default" href="">Home
                &nbsp; &nbsp; /</a></li>
            <li class="list-inline-item text-primary">Barudak Well</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
          <div class="image-wrapper">
            <img class="img-fluid w-100" src="img/well.png">
          </div>
        </div>
    ...
    <div class="container">
      <div class="row justify-content-around align-items-center">
        <div class="col-12 mb-5 text-center">
          <h2>Apa misi utama perusahaan</h2>
        </div>
        
        <div class="col-lg-4 col-md-6 text-center">
          <h4 class="mission-name mb-4">Optimize</h4>
          <p class="mx-lg-3">Lorem ipsum dolor sit amet, sadipscing elitr, sed diam nonumy  tempor invidunt labore  magna aliquyam</p>
        </div>
      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-5 col-md-6 order-2 order-md-1">
          <div class="pr-lg-3 pr-0">
            <h2 class="mb-4">Kami memiliki tim hebat yang terdiri dari pemimpin hebat</h2>
        ...
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0 order-1 order-md-2">
          <div class="image-wrapper">
            <img class="img-fluid w-100" src="img/pdi-well.jpeg">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
          <div class="video-wrapper">
            <img src="img/banteng.jpg" class="img-fluid rounded">
            <a class="play-btn video-btn" data-toggle="modal" data-src="https://youtu.be/-Hfs3xahPCs?si=ibpMG4H8gR6ZtZtJ" data-target="#myModal" href="#"><i class="ti-control-play"></i></a>
          </div>
        </div>
        <div class="col-lg-5 col-md-6 text-center text-md-left">
          <h2 class="mb-4">Don’t forget to subscribe Our Youtube channel “PDI Perjuangan!”</h2>
          <a href="https://youtu.be/-Hfs3xahPCs?si=ibpMG4H8gR6ZtZtJ" class="btn btn-primary">Visit Channel</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-8 mx-auto text-center">
          <h2 class="mb-4">Bergabunglah dengan Partai Berkualitas Terbesar dan Terhebat Di Dunia!</h2>
          <p class="mb-4">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, diam nonumy eirmod tempor labore dolore</p>
